...
export class AuthservicesService {
  ...
  getOrders(RestaurandId:any):Observable<any>{
    return this._HttpClient.get(`https://localhost:7145/api/orders/${RestaurandId}`)
 
  }
  CreatOrders(UserData:object):Observable<any>{
    return this._HttpClient.post(`https://localhost:7145/api/orders/create`,UserData)
  }
  updataorder(UserData:object):Observable<any>{
    return this._HttpClient.put(`https://localhost:7145/api/orders/update`,UserData)
  }
  Deleteorder(ID:any):Observable<any>{
    return this._HttpClient.delete(`https://localhost:7145/api/orders/delete/${ID}`)
  };
  getResturantEmployee(resturantId:any):Observable<any>{
    return this._HttpClient.get(`https://localhost:7145/api/Resturants/GetById/${resturantId}`)
